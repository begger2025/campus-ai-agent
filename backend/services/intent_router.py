...
- complex_analysis：需要对比多个话题、综合多类信息或分多步检索才能回答的复杂问题
  ...
  **用户明确要求联网检索/查最新公开信息时（如"联网查操场翻新"）也归此类**
- search：以上都不符合时的默认检索
...
- "switch"：本句自己点名了一个具体话题。**与有没有上一轮话题无关——对话的第一句点名了
  话题也是 switch**（如"请给我一份宿舍搬迁舆情简报" → switch，keyword 宿舍搬迁）。
- "global"：本句没点名任何具体话题、也不在延续旧话题的全局提问
  （如"最近有什么热点""整体风险如何""给我一份校园舆情简报"）。
