...
| 7 | 07-19 | 安全B+设施：zhihu 12/12（零失败但仅电动车 1 条——设施词知乎实测极冷，empty_page/window_exhausted 干净见底非故障；知乎登录态过期靠清 browser_data 重扫恢复。消防/施工/修路建议第 8 轮补播 wb） | 1 | — | 1257 | 12.7% | 0（draft 107） |
| 订阅首跑 | 07-19 | **订阅通道**（非关键词轮次）：官微 wb creator 101/101 全入库（冷启动 10 页刹车如设计触发），**近30天占比单跑从 12.7% 跃至 19.1%**——订阅盯当下/搜索捞历史的互补实证；贴吧吧订阅列表页解析 0 条（KNOWN-07 待适配，不阻塞） | 101 | — | 1358 | **19.1%** | 0（draft 92；另 AI 代审当日发布 4/驳回 15） |
